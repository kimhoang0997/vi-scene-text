...
images_path = "dataset/train_data"
label_path = "dataset/train_data/test_list.txt"
# output_path = "D:\\GitHub\\vi-scene-text\\train_data\\vin\\rec\\out_test\\"
...
for image_path in glob(path.join(images_path, "*")):
